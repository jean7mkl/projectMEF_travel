    ...
    <div class="content2">
        <div class="text2">
            ...
            <p>Créée en 2018, VoyaQuiz est une agence de voyage innovante qui simplifie l'organisation de séjours en proposant une expérience entièrement personnalisée. Contrairement aux agences traditionnelles qui offrent des itinéraires standards, nous utilisons un quiz intelligent pour créer un voyage qui vous correspond parfaitement.
                ...
                Avec VoyaQuiz, </br>laissez-vous guider et partez l’esprit léger. Faites le quiz dès maintenant et découvrez votre prochaine destination !</p>
            <a href="#" class="btnpres">Prendre contact avec un spécialiste</a>
        </div>
